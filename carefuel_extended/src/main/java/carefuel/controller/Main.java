...
public class Main {
	...
	public static void main(String[] args) {
		...
		// databaseHandler.getAllGasStations().stream().collect(Collectors.toList());
		...
		databaseHandler.getNeighbors(UUID.fromString("550e8400-e29b-11d4-a717-446655440000"), 100000);
